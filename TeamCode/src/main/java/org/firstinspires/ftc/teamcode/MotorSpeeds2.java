...
/**
 * Created by Aryeh on 1/14/18.
 */

public class MotorSpeeds2 extends Object {
    ...
    public MotorSpeeds2(double frontL, double frontR, double backL, double backR) {
        frontLeft = frontL;
        frontRight = frontR;
        backLeft = backL;
        backRight = backR;
    ...
    public MotorSpeeds2(DcMotor frontL, DcMotor frontR, DcMotor backL, DcMotor backR) {

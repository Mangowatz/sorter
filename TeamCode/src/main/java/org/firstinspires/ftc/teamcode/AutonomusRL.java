...
@Autonomous(name="AutoRL", group="Autonomus")
@Disabled
public class AutonomusRL extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //Lower block raiser
        MecanumAutonomus.moveDcMotorEncoded(blockRaiser,1.0,2100);
        ...
        shouldn't need because of sensor
        closeBlockClaw();
